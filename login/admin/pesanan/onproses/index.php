...
if (isset($_POST['btnConfirm'])) {
    ...
    header("location: ../../laporan/?confirm-success");
}
...
<head>
    ...
    <title>TAMA Catering | Pesanan dalam Proses</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 main-content bg-dark sticky-lg-top">
                <span class="fs-3 text-white">> Pesanan > dalam Proses</span>
            </main>
            <!-- Content -->
            <div class="col-md-10 ms-sm-auto col-lg-10 px-md-4 main-content content-section">
                ...
                <div class="alert alert-success alert-dismissible d-flex align-items-center fade show" role="alert">
                    ...
                    <div>
                        <b>Berhasil</b> mengkonfirmasi pesanan
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <?php
                } else if (isset($_GET['cancel-success'])) {
                ?>
                <div class="alert alert-success alert-dismissible d-flex align-items-center fade show" role="alert">
                    <svg class="bi bi-check-circle-fill me-2" width="1em" height="1em" viewBox="0 0 16 16"
                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card-body" style="background-color: #E0E0E0;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-hover bg-light">
                                ...
                                $no = 1;
                                $query = mysqli_query($conn, "SELECT * FROM orders INNER JOIN menu ON menu.id = orders.menu_id WHERE status='Proses' ORDER BY created_at ASC");
                                ...
                                <tbody class="table-group-divider">
                                    <tr>
                                        ...
                                        <td><button class="btn btn-primary text-white btn-sm"
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <form
                                                    onclick="return confirm('Konfirmasi telah selesai pada pesanan ini?')"
                                                    action="" method="POST">
                                                    <input type="hidden" name="order_id"
                                                        value="<?= $data['order_id'] ?>">
                                                    <input type="hidden" name="status" value="Done">
                                                    <button type="submit" name="btnConfirm" class="btn btn-success"><i
                                                            class="fa fa-check"></i>
                                                    </button>
                                                </form>
                                                <form
                                                    ...
                                                    <input type="hidden" name="order_id"
                                                        value="<?= $data['order_id'] ?>">
                                                    <button type="submit" name="btnCancel" class="btn btn-danger"><i
