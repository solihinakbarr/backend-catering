...
<head>
    ...
    <title>TAMA Catering | Laporan</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 d-md-block bg-primary sidebar">
                <div class="position-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item border-bottom">
                            <a href="#" class="nav-link active"><i class="fa fa-file-text-o me-1"></i> Laporan</a>
                        </li>
                        <li class="nav-item border-bottom">
            ...
            <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 main-content bg-dark sticky-lg-top">
                <span class="fs-3 text-white">> Laporan</span>
            </main>
            <!-- Content -->
            <div class="col-md-10 ms-sm-auto col-lg-10 px-md-4 main-content content-section">
                <a href="./cetak/" class="btn btn-success mb-3"><i class="fa fa-print"></i> Cetak</a>
                <?php
                ...
                <div class="card">
                    <div class="card-body" style="background-color: #E0E0E0;">
                        <!-- tabel untuk menampilkan pesanan dan pendapatan -->
                                    ...
                                    ?>
                                        <tbody class="table-group-divider">
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-success text-white btn-sm d-flex align-items-center gap-1" disabled><i class="fa fa-check-circle"></i>
                                                        <?= $data['status'] ?></button>
                                                </td>
                                            </tr>
                                        </tbody>
